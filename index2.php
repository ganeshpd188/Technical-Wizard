		...
		<div class="container">
			<div class="row">
				<div class="col-xs-14 col-sm-7 col-lg-7">
					...
					<ul>
					<li>You need to Enter your valid Email Id(if selected Results will be mailed to you on this email id)</li>
					...
					<li>In case of any problem, directly mail us at ganeshpd188@gmail.com</li>
