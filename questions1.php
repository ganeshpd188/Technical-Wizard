...
$category='';
 if(!empty($_POST['name'])){
     ...
     mysql_query("INSERT INTO users (id, user_name,score1,score2,score3,score4,score5,category_id)VALUES ('NULL','$name',0,0,0,0,0,'$category')") or die(mysql_error());
     $_SESSION['name']= $name;
